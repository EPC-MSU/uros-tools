 ...
 * Copyright (C) 2014-2015 T-Platforms
 *
...
#define SPANSION_S25FL128	0x2018	/* Same ID for various S25FL127S, S25FL128P, S25FL128S and S25FL129P (including dual-die S70FL256P) variants (EDI supported) */#define SPANSION_S25FL128S_1	0x20184D00 /* 64 x 256KB sectors, Note: P/N is ...1, but the id is 00 */
#define SPANSION_S25FL128S_1	0x20184D00 /* 64 x 256KB sectors, Note: P/N is ...1, but the id is 00 */
#define SPANSION_S25FL128S_0	0x20184D01 /* 256 x 64KB sectors, Note: P/N is ...0, but the id is 01 */
#define SPANSION_S25FL128P_01	0x20180300 /* 64 x 256KB sectors, Note: P/N is ...01, but the id is 00 */
#define SPANSION_S25FL128P_00	0x20180301 /* 256 x 64KB sectors, Note: P/N is ...00, but the id is 01 */
#define SPANSION_S25FL512S	0x0220
